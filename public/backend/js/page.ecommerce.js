!(function (t) {
    ...
    13: function (t, r, n) {
        ...
        (t.exports = function (t, r, n, u) {
            ...
            "function" == typeof n && ("string" != typeof r || i(n, "name") || o(n, "name", r), (s(n).source = l.join("string" == typeof r ? r : ""))),
                t !== e ? (c ? !p && t[r] && (f = !0) : delete t[r], f ? (t[r] = n) : o(t, r, n)) : f ? (t[r] = n) : a(r, n);
    ...
    134: function (t, r, n) {
        ...
        var e = n(6),
            ...
            at = function (t, r, n) {
                t === B && at(Q, r, n), v(t);
                var e = h(r, !0);
                return v(n), l(K, e) ? (n.enumerable ? (l(t, V) && t[V][e] && (t[V][e] = !1), (n = b(n, { enumerable: m(0, !1) }))) : (l(t, V) || $(t, V, m(1, {})), (t[V][e] = !0)), et(t, e, n)) : $(t, e, n);
            },
            ut = function (t, r) {
                v(t);
                var n = g(r),
        ...
        (c ||
            (C(
                (U = function () {
                    ...
                    return u && nt && et(B, r, { configurable: !0, set: n }), ot(r, t);
                }).prototype,
                "toString",
                function () {
                    return G(this).tag;
            ...
            u &&
                ...
                a || C(B, "propertyIsEnumerable", ct, { unsafe: !0 }))),
    ...
    173: function (t, r, n) {
        ...
        t.exports = function (t) {
            var r,
                ...
                b = f(v),
                S = 0;
            if ((m && (h = e(h, g > 2 ? arguments[2] : void 0, 2)), null == b || (d == Array && a(b)))) for (n = new d((r = u(v.length))); r > S; S++) (y = m ? h(v[S], S) : v[S]), c(n, S, y);
            else for (p = (l = b.call(v)).next, n = new d(); !(s = p.call(l)).done; S++) (y = m ? i(l, h, [s.value, S], !0) : s.value), c(n, S, y);
            return (n.length = S), n;
        };
    },
    18: function (t, r, n) {
        ...
        var e,
            ...
            v = function () {
                ...
                v = e
                    ...
                    : (((r = f("iframe")).style.display = "none"), c.appendChild(r), (r.src = String("javascript:")), (t = r.contentWindow.document).open(), t.write(y("document.F=Object")), t.close(), t.F);
        ...
        n(134),
            ...
            (function () {
                ...
                !(function (r) {
                    ...
                    a = { datasets: [{ label: "Total Sales", data: a }] };
                    ...
                    (function (r) {
                        ...
                        o = Chart.helpers.merge(
                            {
                                title: { display: !0, fontSize: 12, fontColor: "rgba(54, 76, 102, 0.54)", position: "top", text: "CUSTOMERS OVER TIME" },
                                scales: {
                                    xAxes: [
                                        {
                                            ticks: {
                        ...
                        a = { datasets: [{ label: "Total Customers", data: a, barThickness: 20 }] };
                        Charts.create(r, n, o, a);
                    })("#totalVisitorsChart"),
                    (function (r) {
                        ...
                        try {
                            for (l.s(); !(i = l.n()).done; ) {
                                var p = i.value;
                                a.push({ y: t(0, 5), x: p.toDate() }), u.push({ y: t(5, 10), x: p.toDate() });
                            }
                        } catch (t) {
                            l.e(t);
                        } finally {
                        ...
                        var y = {
                            datasets: [
                                { label: "First time", data: a },
                                { label: "Returning", data: u },
                            ],
                        };
                    ...
                    (function (r) {
                        ...
                        a = { datasets: [{ label: "Total Orders", data: a }] };
                        Charts.create(r, n, o, a);
                    })("#totalOrdersChart"),
                    (function (r) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "line",
                    ...
                    (function (t) {
                        ...
                        try {
                            for (s.s(); !(o = s.n()).done; ) {
                                ...
                                i.push({ y: p, x: l.toDate() }), a.push({ y: Math.round(0.1 * p), x: l.toDate() });
                            }
                        } catch (t) {
                            s.e(t);
                        } finally {
    ...
    98: function (t, r, n) {
        ...
        t.exports = function (t, r, n, s, y, m, b) {
            ...
            if (
                (k && ((S = i(k.call(new t()))), v !== Object.prototype && S.next && (l || i(S) === v || (a ? a(S, v) : "function" != typeof S[g] && c(S, g, h)), u(S, M, !0, !0), l && (p[M] = h))),
                "values" == y &&
                    T &&
                    "values" !== T.name &&
                    ((A = !0),
                ...
                if (((x = { values: w("values"), keys: m ? C : w("keys"), entries: w("entries") }), b)) for (O in x) (d || A || !(O in j)) && f(j, O, x[O]);
